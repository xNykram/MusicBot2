...
@pytest.mark.parametrize("video_url", [("https://youtube.com/test_vide_id"), ("https://soundcloud.com/test_vide_id")])
def test_search_yt(monkeypatch, video_url):
    
    fake_song = Song(id="123", name="TestSong", url="https://fake_url.com/test_url", duration="1:00")
